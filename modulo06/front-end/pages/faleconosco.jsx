    ...
    return (
        <>
            <Head>
                ...
                <title>FnViagens - Fale Conosco</title>
            </Head>
                            ...
                            <form className="needs-validation" noValidate="">
                                <div className="row g-3">
                                    <div className="col-sm-6">
                                        ...
                                        <input type="text" className="form-control" id="nome" value={contato.nome} onChange={handleInputChange} name="nome" />
                                    </div>
                                    <div className="col-sm-6">
                                        <label htmlFor="email" className="form-label">E-mail</label>
                                        <input type="email" className="form-control" id="email" placeholder="nome@exemplo.com" name="email" value={contato.email} onChange={handleInputChange} required />
                                    </div>
                                    <div className="mb-3">
