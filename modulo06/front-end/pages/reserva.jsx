  ...
  return (
    <>
      <Head>
        ...
        <title>FnViagens - Reservas</title>
      </Head>
              ...
              <tbody>
                {reservas.map(({ id, cliente, destino, data }) => (
                  <tr key={id}>
                    ...
                    <td>
                      <Link href={`/update-reserva/${id}`} className="btn btn-primary btn-edit m-1">
                        Editar
                      </Link>
                      <button onClick={() => deleteReserva(id)} className="btn btn-danger btn-edit m-1">
                        Excluir
                      </button>
                    </td>
                  </tr>
