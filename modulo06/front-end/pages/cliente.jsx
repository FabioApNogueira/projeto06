  ...
  return (
    <>
      <Head>
        ...
        <title>FnViagens - Clientes</title>
      </Head>
              ...
              <tbody>
                {clients.map(({ id, nome, email, cpf, dataNascimento, telefone }) => (
                  <tr key={id}>
                    ...
                    <td>{telefone}</td>
                    <td>
                      <Link href={`/update-client/${id}`} className="btn btn-primary btn-edit m-1">
                        Editar
                      </Link>
                      <button onClick={() => deleteCliente(id)} className="btn btn-danger btn-edit m-1">
                        Excluir
                      </button>
                    </td>
                  </tr>
