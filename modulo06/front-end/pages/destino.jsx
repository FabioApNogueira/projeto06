  ...
  return (
    <>
      <Head>
        ...
        <title>FnViagens - Destinos</title>
      </Head>
              ...
              <tbody>
                {destinos.map(({ id, nome, valor }) => (
                  <tr key={id}>
                    ...
                    <td>R$ {valor}</td>
                    <td>
                      <Link href={`/update-destino/${id}`} className="btn btn-primary btn-edit m-1">
                        Editar
                      </Link>
                      <button onClick={() => deleteDestino(id)} className="btn btn-danger btn-edit m-1">
                        Excluir
                      </button>
                    </td>
                  </tr>
